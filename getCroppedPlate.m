function [ finalIMG ] = getCroppedPlate( Im )
...
axis;
croppedImage = imcrop(Im,[ corner1, corner2, corner3, corner4 ]);
finalIMG = getTransformedPlate(croppedImage);
subplot(2,2,2);imshow(finalIMG); title('Detected Plate');
